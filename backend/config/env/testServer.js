...
module.exports = {
  msHost: '129.146.211.219', // Host address for http service of Managing Server
  msDomain: 'cats0713.keyway.dev', // Host Domain name (이 값이 ''이면 https 서버를 열지 않음 이 값으로 인증서 파일 열기를 시도함 'oracle.keyway.dev')
